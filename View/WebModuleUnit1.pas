...
type
  TWebModule1 = class(TWebModule)
    ...
    ServerEntidadeExemplo: TDSServerClass;
    ...
    procedure ServerEntidadeExemploGetClass(DSServerClass: TDSServerClass;
      var PersistentClass: TPersistentClass);
    procedure DSRESTWebDispatcher1FormatResult(Sender: TObject; var ResultVal: TJSONValue;
...
uses ServerMethodsUnit1, Web.WebReq, View.Entidade.Exemplo;

procedure TWebModule1.DSRESTWebDispatcher1FormatResult(Sender: TObject;
  var ResultVal: TJSONValue; const Command: TDBXCommand; var Handled: Boolean);
var lcvJSONValue : TJSONValue;
begin
...
procedure TWebModule1.ServerEntidadeExemploGetClass(DSServerClass: TDSServerClass;
  var PersistentClass: TPersistentClass);
begin
  PersistentClass := View.Entidade.Exemplo.TExemplo;
end;
